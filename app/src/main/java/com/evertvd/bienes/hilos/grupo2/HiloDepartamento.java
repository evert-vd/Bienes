package com.evertvd.bienes.hilos.grupo2;
 ...
 */
    ...
    public class HiloDepartamento extends Thread {
    private String path;
    Context context;

    public HiloDepartamento(ThreadGroup nombreGrupo,String nombreHilo, String path) {
        this.path=path;
        ...
        public void run() {
            ...
            Log.e("hiloDep", String.valueOf(time2));
