package com.evertvd.bienes.scannercode;
...
public class MaterialBarcodeScannerActivity extends AppCompatActivity {
    ...
    //private ImageButton btnZoomDisabled, zoomEnabled;
    ...
    private void setupButtons() {
        ...
        zoomControls.setOnZoomInClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                int zoom2=+2;
                mMaterialBarcodeScannerBuilder.getCameraSource().doZoom(zoom2);
                zoom+=zoom2;
        ...
        zoomControls.setOnZoomOutClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                    mMaterialBarcodeScannerBuilder.getCameraSource().doZoom(0);
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (event.getAction()) {
            case MotionEvent.ACTION_DOWN:
                mMaterialBarcodeScannerBuilder.getCameraSource().doZoom(eventY);
                //return true;
            break;
    ...
    public class MyOnScaleGestureListener extends
        ...
        public boolean onScale(ScaleGestureDetector detector) {
            ...
            if (scaleFactor > 1) {
                ...
                zoom=zoom+2;
                mMaterialBarcodeScannerBuilder.getCameraSource().doZoom(scaleFactor);
                Log.e("zoom","+zoom" + String.valueOf(scaleFactor)+" zoom:"+zoom);
            } else {
