...
import com.evertvd.bienes.searchablespinner.interfaces.ISpinnerSelectedView;
import com.evertvd.bienes.searchablespinner.tools.UITools;

/**
 * Created by evertvd on 11/10/2017.
 */

public class ListSpinnerSearchAdapter extends BaseAdapter implements Filterable, ISpinnerSelectedView {
    ...
    public ListSpinnerSearchAdapter(Context context, ArrayList<String> strings) {
        mContext = context;
        mStrings = strings;
