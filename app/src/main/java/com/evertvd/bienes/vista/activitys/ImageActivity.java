...
public class ImageActivity extends BaseActivity {
    ...
    private void setupUI() {
        ...
        mTextViewQuality.setText(String.format("adsdad", mSeekBarQuality.getProgress()));
        mSeekBarQuality.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            @Override
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                mTextViewQuality.setText(String.format("adsad", progress));
            }
    ...
    private void pickFromGallery() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN
            ...
            requestPermission(Manifest.permission.READ_EXTERNAL_STORAGE, "permiso denegado",
    ...
    private void startCropActivity(@NonNull Uri uri) {
        ...
        uCrop.start(ImageActivity.this);
    }
    ...
    private void handleCropResult(@NonNull Intent result) {
        ...
        if (resultUri != null) {
            ResultActivity.startWithUri(ImageActivity.this, resultUri);
        } else {
            Toast.makeText(ImageActivity.this, "No hay permiso", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void handleCropError(@NonNull Intent result) {
        ...
        if (cropError != null) {
            ...
            Toast.makeText(ImageActivity.this, cropError.getMessage(), Toast.LENGTH_LONG).show();
        } else {
            Toast.makeText(ImageActivity.this, "Errrorrr", Toast.LENGTH_SHORT).show();
        }
    }
