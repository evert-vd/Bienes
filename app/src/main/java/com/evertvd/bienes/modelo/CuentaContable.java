...
/**
 * Entity mapped to table "CUENTA_CONTABLE".
 */
@Entity(active = true)
public class CuentaContable {
    ...
    @Generated
    private transient CuentaContableDao myDao;

    @ToMany(joinProperties = {
        @JoinProperty(name = "id", referencedName = "cuentacontable_id")
    })
    ...
    @Generated
    public CuentaContable(Long id, String codigo) {
        this.id = id;
        this.codigo = codigo;
    }
    ...
    public void __setDaoSession(DaoSession daoSession) {
        ...
        myDao = daoSession != null ? daoSession.getCuentaContableDao() : null;
    }
    ...
    public List<Activo> getActivoList() {
        if (activoList == null) {
            ...
            List<Activo> activoListNew = targetDao._queryCuentaContable_ActivoList(id);
            synchronized (this) {
                if(activoList == null) {
