...
/**
 * Entity mapped to table "RESPONSABLE".
 */
@Entity(active = true)
public class Responsable {
    ...
    @Generated
    private transient ResponsableDao myDao;

    @ToMany(joinProperties = {
        @JoinProperty(name = "id", referencedName = "responsable_id")
    })
    ...
    @Generated
    public Responsable(Long id, String responsable) {
        this.id = id;
    ...
    public void __setDaoSession(DaoSession daoSession) {
        ...
        myDao = daoSession != null ? daoSession.getResponsableDao() : null;
    }
    ...
    public List<Activo> getActivoList() {
        if (activoList == null) {
            ...
            List<Activo> activoListNew = targetDao._queryResponsable_ActivoList(id);
            synchronized (this) {
                if(activoList == null) {
