...
public class DaoSession extends AbstractDaoSession {
    ...
    private final DaoConfig activoAllDaoConfig;
    ...
    private final ActivoAllDao activoAllDao;
    ...
    public DaoSession(Database db, IdentityScopeType type, Map<Class<? extends AbstractDao<?, ?>>, DaoConfig>
        ...
        activoAllDaoConfig = daoConfigMap.get(ActivoAllDao.class).clone();
        activoAllDaoConfig.initIdentityScope(type);
        ...
        activoAllDao = new ActivoAllDao(activoAllDaoConfig, this);
        ...
        registerDao(ActivoAll.class, activoAllDao);
    }
    ...
    public void clear() {
        ...
        activoAllDaoConfig.clearIdentityScope();
    }
    ...
    public ActivoAllDao getActivoAllDao() {
        return activoAllDao;
    }
